...
import { bindings } from '../Electricity/ElectricityOrderID';

const PaymentComponentElectricity = ({ billAmt, triggerNextStep }) => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            console.log("response is ==> ", bindings);
...
export default PaymentComponentElectricity;